    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="" href=""
                   data-toggle="dropdown" >
                    <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder"><?php echo $_SESSION['admins']['admins_namesurname'];?></span>
                     </div>
                    <span class="avatar">
                        <img class="round" src="dimg/admins/<?php echo $_SESSION['admins']['admins_file']; ?>" alt="avatar" height="40" width="40">

                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                 <!--   <a class="dropdown-item" href=""><i class="mr-50" data-feather="user"></i> Profile</a> -->
                    <a class="dropdown-item" href="logout.php"><i class="mr-50" data-feather="power"></i>Çıkış Yap</a>
                </div>
            </li>
        </ul>
    </div>
