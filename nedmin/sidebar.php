    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand center" href="index.php" style="margin: auto" >
                          <img src="Masadancom.svg" class="mr-2 center" align="center" width="45"  height="45" style="margin-bottom: auto; margin-top: auto">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="index.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" style="margin-top: -10px;"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" ></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                    <span class="menu-title text-truncate" data-i18n="Dashboards">Pano</span>
            </li>
         <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Apps &amp; Pages</span><i data-feather="more-horizontal"></i>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="admins.php"><i data-feather='users'></i>
                <span class="menu-item text-truncate" >Yöneticiler</span>

                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="users.php"> <i data-feather='user'></i>
                 <span class="menu-item text-truncate">Kullanıcılar</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="settings.php"> <i data-feather='settings'></i>
               <span class="menu-item text-truncate" >Ayarlar</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="sliders.php" > <i data-feather='image'></i>
               <span class="menu-item text-truncate" >Sliders</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="blogs.php"> <i data-feather='book-open'></i>
              <span class="menu-item text-truncate" >Blogs</span>
                </a>
            </li>
